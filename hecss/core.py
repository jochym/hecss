...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/11_core.ipynb.
    ...
    **Output parameters**
    ...
    while True:
        ...
        try :
            ...
            print(f"Calculator in {cr.calc.directory} failed.\n", file=sys.stderr)
            print("Replacing with next displacement.", file=sys.stderr)
            continue
...
# %% ../nbs/11_core.ipynb 12
from hecss.optimize import make_sampling

# %% ../nbs/11_core.ipynb 13
@patch
