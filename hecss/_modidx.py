...
d = { 'settings': { 'branch': 'devel',
  ...
  'syms': { 'hecss.cli': { 'hecss.cli.calculate_xscale': ('cli.html#calculate_xscale', 'hecss/cli.py'),
            ...
            'hecss.parallel': { 'hecss.parallel.HECSS.estimate_width_scale_aio': ( 'parallel.html#hecss.estimate_width_scale_aio',
                                                                                   'hecss/parallel.py'),
                                'hecss.parallel.Vasp._arun': ('parallel.html#vasp._arun', 'hecss/parallel.py'),
                                'hecss.parallel.Vasp.calculate_aio': ('parallel.html#vasp.calculate_aio', 'hecss/parallel.py'),
