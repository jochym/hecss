...
d = { 'settings': { 'branch': 'devel',
  ...
  'syms': { 'hecss.cli': { 'hecss.cli.calculate_xscale': ('cli.html#calculate_xscale', 'hecss/cli.py'),
            ...
            'hecss.mh': { 'hecss.mh.HECSS': ('mh.html#hecss', 'hecss/mh.py'),
                          'hecss.mh.HECSS.__init__': ('mh.html#__init__', 'hecss/mh.py'),
                          'hecss.mh.HECSS.generate': ('mh.html#generate', 'hecss/mh.py'),
                          'hecss.mh.HECSS_Sampler': ('mh.html#hecss_sampler', 'hecss/mh.py'),
                          'hecss.mh.calc_init_xscale': ('mh.html#calc_init_xscale', 'hecss/mh.py'),
                          'hecss.mh.normalize_conf': ('mh.html#normalize_conf', 'hecss/mh.py'),
                          'hecss.mh.select_asap_model': ('mh.html#select_asap_model', 'hecss/mh.py'),
