...
def _(mo):
    ...
    > Implementation of async/parallel generator executing calculations in a pool of nwork workers. Implemented for VASP but should be fairly easy to port/extend to other directory/cluster-based calculators.
    """)
    return
